...
public class StructleTypes {
    ...
    public static class ProtocolField {
        private static final String TAG = ProtocolField.class.getSimpleName();
    ...
    public static class RoutingField {
        private static final String TAG = RoutingField.class.getSimpleName();
    ...
    public static class Int8 {
        private static final String TAG = Int8.class.getSimpleName();
        private byte[] data;
    ...
    public static class UInt8 {
        private static final String TAG = UInt8.class.getSimpleName();
        private byte[] data;
    ...
    public static class Int16 {
        private static final String TAG = Int16.class.getSimpleName();
        private byte[] data;
    ...
    public static class UInt16 {
        ...
        private static final String TAG = UInt16.class.getSimpleName();
...
//			}
    ...
    public static class Int32 {
        private static final String TAG = Int32.class.getSimpleName();
        private byte[] value;
    ...
    public static class UInt32 {
        private static final String TAG = UInt32.class.getSimpleName();
        private byte[] value;
...
//			}
    ...
    public static class Int64 {
        private static final String TAG = Int64.class.getSimpleName();
        private byte[] value;
    ...
    public static class Bool8 {
        private static final String TAG = Bool8.class.getSimpleName();
        private byte[] data;
    ...
    public static class Float32 {
        private static final String TAG = Float32.class.getSimpleName();
        private byte[] value;
    ...
    public static class Double64 {
        private static final String TAG = Double64.class.getSimpleName();
        private byte[] value;
